            ...
            while true do
                ...
                if isrbxactive() and kbWidget then
                    ...
                    if down and not lastDown then
                        ...
                        MatchaUI.Notify(
                            win.Visible and "UI Shown" or "UI Hidden",
                            "Bound to VK " .. tostring(kbWidget.Key),
                            2
                        )
                    end
                    lastDown = down
